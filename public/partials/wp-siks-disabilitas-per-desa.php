...
<h1 class="text-center">Peta Sebaran Disabilitas<br>DESA <?php echo $validate_user['desa']; ?></h1>
<div style="width: 95%; margin: 0 auto; min-height: 90vh; padding-bottom: 75px;">
    <div id="map-canvas-siks" style="width: 100%; height: 400px;"></div>
    <h1 class="text-center" style="margin:3rem;">Tabel Data Disabilitas Desa <?php echo $validate_user['desa']; ?></h1>
