...
$hibah_all = $this->get_hibah();
$this->functions->generatePage(array(
    'nama_page' => 'Hibah Per Desa',
    'content' => '[hibah_per_desa]',
    'show_header' => 1,
    'no_key' => 1,
    'post_status' => 'publish'
));
...
foreach ($maps_all as $i => $desa) {
    ...
    $html = '
        <table>
            <tr>
                <td><b>Total Penerima Hibah</b></td>
    ...
    if (is_user_logged_in()) {
        $link_per_desa = add_query_arg('desa', urlencode($desa['data']['desa']), home_url('/hibah-per-desa/'));
    }
...
?>
<h1 class="text-center">Peta Sebaran Penerima Hibah<br><?php echo $this->getNamaDaerah(); ?></h1>
<div style="width: 95%; margin: 0 auto; min-height: 90vh; padding-bottom: 75px;">
    <div id="map-canvas-siks" style="width: 100%; height: 400px;"></div>
    <h3 style="margin-top: 20px;">Keterangan</h3>
    <ol>
        <li>Warna hijau berarti jumlah Penerima Hibah antara 0 sampai 5 orang</li>
        <li>Warna kuning berarti jumlah Penerima Hibah antara 5 sampai 10 orang</li>
        <li>Warna merah berarti jumlah Penerima Hibah diatas 10 orang</li>
    </ol>
    <h1 class="text-center">Tabel Data Penerima Hibah<br>Total <?php echo $this->number_format($total_all); ?> Orang</h1>
        ...
        <table class="table table-bordered" id="table-data">
            <thead>
                <tr>
                    ...
                    <th class='text-center'>Total Penerima Hibah</th>
