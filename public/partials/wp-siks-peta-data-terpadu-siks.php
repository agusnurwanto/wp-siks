...
<div style="width: 95%; margin: 0 auto; min-height: 90vh; padding-bottom: 75px;">
    ...
    <h2 class="text-center">Tabel Data Terpadu<br>Total DTKS <?php echo $this->number_format($total_all_dtks); ?> Orang<br>Total Lansia <?php echo $this->number_format($total_all_lansia); ?> Orang<br>Total Disabilitas <?php echo $this->number_format($total_all_disabilitas); ?> Orang</h1>
